(function () {
  ...
  const niche = root.getAttribute("data-niche") || "default";
  const themePalette = niche === "emotion"
    ? { dark: "#2b2326", light: "#f8e7ea" }
    : { dark: "#0b0f19", light: "#f8fafc" };
  ...
  const updateThemeColor = (t) => {
    if (themeColorMeta) themeColorMeta.setAttribute("content", t === "dark" ? themePalette.dark : themePalette.light);
  };

...
return [
    ...
    'journey' => [
        'intro' => [
            'eyebrow' => 'Jornada terapêutica',
            'title' => 'Uma jornada em duas etapas',
            'text' => 'Antes de iniciar a terapia e o que começa a mudar quando você se escolhe.',
        ],
        'before' => [
            'step' => '1',
            ...
            'image' => [
                'src' => 'assets/img/antes_um.png',
                'alt' => 'Painel visual sobre a fase de sobrecarga emocional antes do processo terapêutico',
                'width' => 1122,
                'height' => 1402,
            ],
            'list_title' => 'Sinais que costumam aparecer no dia a dia',
            'items' => [
                ['icon' => 'heart', 'text' => 'Você sente que precisa dar conta de tudo.'],
                ['icon' => 'heart', 'text' => 'Se cobra constantemente.'],
                ['icon' => 'heart', 'text' => 'Tem dificuldade em descansar sem culpa.'],
                ['icon' => 'heart', 'text' => 'Cuida de todos, mas quase nunca consegue cuidar de si.'],
                ['icon' => 'heart', 'text' => 'Mesmo fazendo tanto, ainda se sente insuficiente.'],
            ],
        ],
        'transition' => [
            'text' => 'Você não precisa continuar sustentando tudo sozinha.',
            'label' => 'Ver o que começa a mudar',
            'href' => '#escolher-se',
        ],
        'after' => [
            'step' => '2',
            ...
            'highlight' => 'Você merece ocupar seu espaço sem precisar se esquecer de si mesma.',
            'image' => [
                'src' => 'assets/img/depois_um.png',
                'alt' => 'Painel visual sobre o processo de se escolher com mais leveza',
                'width' => 1122,
                'height' => 1402,
            ],
            'list_title' => 'Mudanças que começam a aparecer',
            'items' => [
                ['icon' => 'check2-circle', 'text' => 'Reconhecer suas necessidades sem culpa.'],
                ['icon' => 'check2-circle', 'text' => 'Entender que seu valor não depende apenas do quanto você produz, entrega ou cuida dos outros.'],
                ['icon' => 'check2-circle', 'text' => 'Desenvolver relações mais saudáveis.'],
                ['icon' => 'check2-circle', 'text' => 'Estabelecer limites com mais segurança.'],
                ['icon' => 'check2-circle', 'text' => 'Confiar mais na própria voz.'],
                ['icon' => 'check2-circle', 'text' => 'Se posicionar sem sentir que está decepcionando alguém.'],
                ['icon' => 'check2-circle', 'text' => 'Construir uma relação mais gentil consigo mesma.'],
            ],
            'cta' => [
                'label' => 'Quero começar minha terapia',
                'href' => '#agendar',
        ...
        'panels' => [
            'before' => [
                ...
                'alt' => 'Painel ilustrado sobre a fase anterior ao processo terapêutico',
                'width' => 1024,
                'height' => 1536,
            ],
            'after' => [
                'src' => 'assets/img/depois.png',
                'alt' => 'Painel ilustrado sobre o que muda ao iniciar o processo terapêutico',
                'width' => 1024,
                'height' => 1536,
            ],
        ],
    ...
    'form' => [
        ...
        'helper_points' => [
            ...
            [
                ...
                'text' => 'O retorno é feito para organizar horário, formato e orientações do início do acompanhamento.',
            ],
            [
                'icon' => 'shield-lock',
                'title' => 'Sigilo e privacidade',
                'text' => 'Se preferir, deixe detalhes sensíveis para a sessão. O primeiro passo pode ser breve e seguro.',
            ],
        ],
        'fields' => [
            ...
            'message_placeholder' => 'Ex.: Quero iniciar a terapia para trabalhar ansiedade, autoestima e questões familiares.',

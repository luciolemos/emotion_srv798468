...
final class HomeRoutesTest extends TestCase
{
    ...
    public function testHomeRendersCorrectAssetPathsWhenBasePathIsEmpty(): void
    {
        ...
        self::assertStringContainsString('src="/assets/img/img_diversas/jersika_carvalho-desktop-640.webp"', $html);
        self::assertStringContainsString('media="(max-width: 576px)"', $html);
        self::assertStringContainsString('/assets/img/img_diversas/jersika_carvalho-mobile-640.webp', $html);
    ...
    public function testHomeRendersUpdatedClinicHeroCopyAndPaletteStateFromQueryString(): void
    {
        ...
        self::assertStringContainsString('Você não precisa', $html);
    ...
    public function testHomeRendersCoreSectionsAsSmokeCoverage(): void
    {
        ...
        self::assertStringNotContainsString('id="localizacao"', $html);
